...
app.layout = html.Div([
    ...
    html.Div([
        html.Div([
            html.H3("State Ranking of Cumulative Confirmed/Death Cases", style={'textAlign':'center'})
        ]),
...
def update_figure(selected_date_id, btn1, btn2, btn3, btn4, n):
    ...
    fig = px.choropleth(
        ...
        title = 'Date "'+begin_to_end_dates[selected_date_id]+'" - US - Cumulative Cases by State'
    )
    fig.update_layout(
        font=dict(
            size=17,
